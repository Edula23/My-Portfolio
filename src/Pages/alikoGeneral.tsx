...
import img1 from "../assets/alikoHubM1.png";
import img2 from "../assets/alikoHubM2.png";
export default function AlikoHubGeneral() {
    ...
    <div className="min-h-screen  bg-[#000000] text-white flex flex-col relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center mb-10">
        <div className=" md:space-y-60 md:mt-16 md:ml-10">
          <h1 className="text-6xl mb-4 md:text-8xl font-serif">AlikoHub</h1>
          <a
            href="#"
            target="_blank"
