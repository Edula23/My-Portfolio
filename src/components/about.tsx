...
export default function AboutSection () {
  return (
    ...
    <section id="about" className="mt-16 md:mt-50">
      <div className="grid grid-cols-1 md:grid-cols-2  items-center md:justify-between md:gap-6 md:px-24 ">
        {/* Image */}
        ...
        {/* About Note */}
        <div className=' w-full mr-auto md:ml-auto'>
